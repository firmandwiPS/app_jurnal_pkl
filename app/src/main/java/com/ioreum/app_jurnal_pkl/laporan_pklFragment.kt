...
class laporan_pklFragment : Fragment() {
    ...
    private val urlTampil = "http://10.20.28.93/jurnal_pkl/tampil_laporan.php"
    private val urlTambah = "http://10.20.28.93/jurnal_pkl/tambah_laporan.php"
    private val urlHapus = "http://10.20.28.93/jurnal_pkl/hapus_laporan.php"
    private val urlUbah = "http://10.20.28.93/jurnal_pkl/ubah_laporan.php"
    private val urlSiswa = "http://10.20.28.93/jurnal_pkl/tampil_siswa.php"
    private val baseFileUrl = "http://10.20.28.93/jurnal_pkl/uploads/"
