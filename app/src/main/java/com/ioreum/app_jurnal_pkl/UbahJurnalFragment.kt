...
class UbahJurnalFragment : Fragment() {
    ...
    private fun loadSiswa() {
        val url = "http://10.20.28.93/jurnal_pkl/ambil_siswa.php"
    ...
    private fun loadJurnal() {
        val url = "http://10.20.28.93/jurnal_pkl/ambil_jurnal_by_id.php"
        val request = object : StringRequest(Request.Method.POST, url,
            { response ->
                ...
                Glide.with(this)
                    .load("http://10.20.28.93/jurnal_pkl/foto/$oldFileName")
    ...
    private fun uploadUpdate() {
        val url = "http://10.20.28.93/jurnal_pkl/ubah_jurnal.php"
